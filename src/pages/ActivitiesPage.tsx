      ...
      <div className="grid md:grid-cols-2 gap-8">
        ...
        <div className="bg-gradient-to-br from-blue-50 to-green-50 rounded-xl p-8 shadow-lg transform hover:scale-105 transition-transform">
          ...
          <ul className="space-y-4">
            ...
            />
            <ActivityItem icon={<Umbrella className="h-5 w-5 text-yellow-600" />} text="Private sandy beach" />
            <ActivityItem icon={<Waves className="h-5 w-5 text-blue-600" />} text="Beach sauna" />
            <ActivityItem icon={<Ship className="h-5 w-5 text-blue-600" />} text="Rowing boat" />
            <ActivityItem icon={<Waves className="h-5 w-5 text-cyan-600" />} text="Sup-board" />
            <ActivityItem icon={<Ship className="h-5 w-5 text-blue-500" />} text="Kayaks" />
            <ActivityItem icon={<Waves className="h-5 w-5 text-blue-400" />} text="Water running belts" />
            <ActivityItem icon={<Dumbbell className="h-5 w-5 text-gray-600" />} text="Gym" />
          </ul>
        </div>
        ...
        <div className="bg-gradient-to-br from-blue-50 to-purple-50 rounded-xl p-8 shadow-lg transform hover:scale-105 transition-transform">
          ...
          <ul className="space-y-4">
            ...
            <ActivityItem
              ...
              text="2 electric car charging points, where guests can charge free of charge"
            />
            <ActivityItem icon={<Thermometer className="h-5 w-5 text-blue-600" />} text="Avanto" />
            <ActivityItem icon={<Waves className="h-5 w-5 text-blue-600" />} text="Beach sauna" />
            <ActivityItem icon={<Waves className="h-5 w-5 text-orange-600" />} text="Kotalaavu" />
            <ActivityItem icon={<Dumbbell className="h-5 w-5 text-gray-600" />} text="Gym" />
          </ul>
        </div>
      </div>
