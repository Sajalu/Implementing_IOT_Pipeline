...
const AdminDashboard: React.FC = () => {
  ...
  const [chartView, setChartView] = useState("temperature")
        ...
        <main className="p-6">
            ...
            <>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                ...
                <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
                  ...
                  <div className="h-64">
                    <HumidityChart data={mockHumidityData} />
                  </div>
                </div>
              </div>
            </>
          ...
          {activeTab === "temperature" && (
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
              ...
              <div className="h-80">
                <TemperatureChart data={mockTemperatureData} fullWidth />
              </div>
            </div>
          )}
          ...
          {activeTab === "humidity" && (
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
              ...
              <div className="h-80 mb-6">
                <HumidityChart data={mockHumidityData} fullWidth />
              </div>
...
const TemperatureChart: React.FC<{ data: Array<{ time: string; value: number }>; fullWidth?: boolean }> = ({
  data,
  fullWidth = false,
}) => {
  const minTemp = 18
...
const HumidityChart: React.FC<{ data: Array<{ time: string; value: number }>; fullWidth?: boolean }> = ({
  data,
  fullWidth = false,
}) => {
  const minHumidity = 0
