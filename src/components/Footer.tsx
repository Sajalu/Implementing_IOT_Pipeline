        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li><Link to="/cottages" className="hover:text-white transition-colors">Cottages</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li>Finland</li>
              <li>
                <a href="mailto:info@rakkaranta.fi" className="hover:text-white">info@rakkaranta.fi</a>
              </li>
              <li>
                <a href="https://www.rakkaranta.fi" target="_blank" rel="noopener noreferrer" className="hover:text-white">
                  Visit Our Website
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a href="https://www.facebook.com/people/Lomakyl%C3%A4-Rakkaranta/61560052920308/" className="text-gray-400 hover:text-white transition-colors">
                Facebook
              </a>
              <a href="https://www.instagram.com/rakkaranta/" className="text-gray-400 hover:text-white transition-colors">
                Instagram
              </a>
            </div>
          </div>
